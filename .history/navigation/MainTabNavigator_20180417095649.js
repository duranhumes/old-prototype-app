...
import { HomeScreen, NewsScreen, NewsResultScreen, SearchScreen, SearchResultScreen, AroundMeScreen, AroundMeResultScreen, EventScreen, EventResultScreen } from '../screens';
	...
	},
	{
		navigationOptions: ({ navigation }) => ({
			...
			tabBarIcon: ({ focused }) => {
				...
				return <Ionicons name={iconName} size={24} style={{ marginBottom: -3, width: 20, alignItems: 'center' }} color={focused ? Colors.tabIconSelected : Colors.tabIconDefault} />;
			},
		}),
