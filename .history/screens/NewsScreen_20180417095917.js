...
const categories = [{ id: 1, category: 'Breaking' }, { id: 2, category: 'Sports' }, { id: 3, category: 'Technology' }];

class NewsScreeen extends Component {
	...
	render() {
		return (
			<Container>
				<IOSHeader title="News" tabs={this._renderTabs()} go={this.props.navigation} placeholder="Search News..." hasSearch />
			</Container>
		);
	}
}
