...
import { StyleSheet, Dimensions, Platform, View, TextInput, TouchableOpacity, Animated } from 'react-native';
...
class SearchBar extends Component {
	...
	state = {
		...
		top: new Animated.Value(this.props.showOnLoad ? 0 : INITIAL_TOP + this.props.heightAdjust),
	};
				...
				{this.state.show && (
					<View style={[styles.navWrapper, { backgroundColor }]}>
						...
						<View style={[styles.nav, { height: (Platform.OS === 'ios' ? 52 : 62) + heightAdjust }]}>
							{!hideBack && (
								<TouchableOpacity accessible={true} accessibilityComponentType="button" accessibilityLabel={backButtonAccessibilityLabel} onPress={onBack || this.hide}>
									{backButton ? (
